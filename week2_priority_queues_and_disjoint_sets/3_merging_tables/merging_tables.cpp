	...
	void merge(int destination, int source) {
		...
		if (realDestination != realSource) {
            ...
            if(sets[realDestination].rank > sets[realSource].rank){
                ...
                if(sets[realDestination].rank == sets[realSource].rank)sets[realSource].rank++;
            }
            max_table_size = max({sets[realDestination].size,sets[realSource].size,max_table_size});
		}		
	}
};
